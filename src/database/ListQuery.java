...
public class ListQuery {
    ...
    public static Map<String, String> getListQuery() {
        ...
        String deletesServicioByIdOwnerQuery = "DELETE FROM Servicios WHERE PropietarioID = ?";
        String getServicioByIdOwnerQuery = "SELECT IdServicio FROM Servicios WHERE PropietarioID = ?";
        ...
        listQuery.put("DeletesServicioByIdOwner", deletesServicioByIdOwnerQuery);
        listQuery.put("GetServicioByIdOwner", getServicioByIdOwnerQuery);
